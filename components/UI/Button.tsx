...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    primary: 'text-white hover:opacity-95 focus:ring-[--ring-color]',
    secondary: 'text-slate-800 bg-slate-100 hover:bg-slate-200 focus:ring-slate-500',
    outline: 'text-slate-800 border border-slate-300 hover:bg-slate-50 focus:ring-slate-500',
    ghost: 'text-slate-800 hover:bg-slate-100 focus:ring-slate-500',
